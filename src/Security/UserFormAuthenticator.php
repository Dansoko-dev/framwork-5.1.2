...
class UserFormAuthenticator extends AbstractAuthenticator
{
    private $userRepository;
    private $urlGenarator;

    public function __construct(UserRepository $userRepository, UrlGeneratorInterface $urlGenarator)
    {
    ...
    { 
        ...
        [ 
            new CsrfTokenBadge('moustapha', $request->request->get('csrf_token')),
            new RememberMeBadge
        ]);
...
*/
    ...
    { 
        ...
        return new RedirectResponse($this->urlGenarator->generate("app_login"));
    }
